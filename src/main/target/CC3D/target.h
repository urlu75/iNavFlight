...
#define UART3_TX_PIN            PB10
    ...
    #define ADNS3080_CSN_GPIO                  GPIOA
    #define ADNS3080_CSN_PIN                   GPIO_Pin_0
    #define ADNS3080_CSN_GPIO_CLK_PERIPHERAL   RCC_APB2Periph_GPIOA
    #define ADNS3080_SCK_GPIO                  GPIOB
    #define ADNS3080_SCK_PIN                   GPIO_Pin_5
    #define ADNS3080_MOSI_GPIO                 GPIOB
    #define ADNS3080_MOSI_PIN                  GPIO_Pin_1
    #define ADNS3080_MISO_GPIO                 GPIOB
    #define ADNS3080_MISO_PIN                  GPIO_Pin_0
#endif
